...
class FeatureImportanceAnalyzer:
    ...
    def plot_importance(self, importance_df, top_n=20):
        ...
        plt.tight_layout()
        plt.savefig('/Users/lysandre/Documents/EPFL/LPBS/feature_importance_analysis.png', dpi=300, bbox_inches='tight')
        plt.show()
    ...
    def plot_performance_vs_features(self, performance_df):
        ...
        plt.tight_layout()
        plt.savefig('/Users/lysandre/Documents/EPFL/LPBS/performance_vs_features.png', dpi=300, bbox_inches='tight')
        plt.show()
    ...
    def save_top_features(self, importance_df, top_n=20):
        ...
        top_features = importance_df.head(top_n)
        top_features.to_csv('/Users/lysandre/Documents/EPFL/LPBS/top_features.csv', index=False)
    ...
    def run_full_analysis(self):
        ...
        combined_importance.to_csv('/Users/lysandre/Documents/EPFL/LPBS/all_feature_importance.csv', index=False)
        performance_results.to_csv('/Users/lysandre/Documents/EPFL/LPBS/feature_performance_analysis.csv', index=False)
