...
EXCLUDED_FOLDERS = ['Optogenetics', 'COMPANY DRUG', 'TERBINAFINE_OLD']
...
def preprocess_data(file_path, full_output_dir, segments_output_dir):
    ...
    death_segment = int(matching_rows.iloc[0]['Seconds5x'] / SEGMENT_LENGTH) + 1 # +1 to include the death segment
